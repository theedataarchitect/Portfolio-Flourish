...
export const TelemetrySection: React.FC<TelemetrySectionProps> = ({ onOpenInquiry }) => {
  return (
    <section
      id="telemetry"
      className="py-20 lg:py-28 bg-white/70 dark:bg-slate-950/70 backdrop-blur-xs border-b border-slate-200 dark:border-slate-800/80 transition-colors duration-200"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="rounded-2xl bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 p-6 flex flex-col justify-between shadow-xs">
                <div>
                  <div className="flex items-center justify-between font-mono text-[10px] uppercase tracking-wider mb-3 pb-2 border-b border-slate-100 dark:border-slate-800">
